#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""v5.6 phase-aware Stop hook for Claude Code.

Reads project_mode / harness_phase from memory-registry via
`check_memory_consistency.py --print-phase`, then:

- discovery_only / shadow_harness : warn_only — never block.
- soft_gate                       : block only when failing errors mention
                                    governance_paths from memory-registry.yaml.
- managed_harness                 : block on any failure (legacy behaviour).
"""
